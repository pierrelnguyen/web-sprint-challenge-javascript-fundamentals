...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested functions can access the variable internal because everything is within the function myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    let america = arr.reduce((pop, element) => {
      return pop + element.population
    },0);
    return america;
  }
